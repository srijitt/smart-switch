...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(auth)` | `/(devices)` | `/(tabs)` | `/_sitemap` | `/addDevice` | `/context/timerContext` | `/context/userContext` | `/controlPanel` | `/create` | `/profile` | `/signin` | `/signup` | `/support` | `/updateDevice`;
